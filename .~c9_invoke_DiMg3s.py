...
def aperitif():
    ...
    return render_template("recipes.html",
                             recipes=recipe_list , pagination=pagination, title="Aperitifs")
...
def starter():
    ...
    recipe_list = paginate_list(recipes, page, 10)
    return render_template("recipes.html",
                             recipes=recipe_list , pagination=pagination, title="Starters")
...
def intermediate():
    ...
    recipe_list = paginate_list(recipes, page, 10)
    return render_template("recipes.html",
                             recipes=recipe_list , pagination=pagination, title="Intermediate")
...
def main():
    ...
    recipe_list = paginate_list(recipes, page, 10)
    return render_template("recipes.html",
                             recipes=recipe_list , pagination=pagination, title="Mains")
...
def dessert():
    ...
    recipe_list = paginate_list(recipes, page, 10)
    return render_template("recipes.html",
                             recipes=recipe_list , pagination=pagination, title="Dessert")
